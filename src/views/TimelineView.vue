...
export default {
    data() {
      return {
        ...
        url_Poule: process.env.BASE_URL + "datas/matchs_poules_seniors.json",
                ...
                .then(response => {
                  ...
                  for (var n in this.lesmatchs ) {
                    ...
                    if (this.lesmatchs[n].cat_code=="cat1") {
                        ...
                        } else if (this.lesmatchs[n].poule=="PB") {
                            this.lesmatchs[n].color = "colorPB"
                        } else {
                            this.lesmatchs[n].color = "colorPC"
                        }
                    } else {
                        if (this.lesmatchs[n].poule=="PD") {
                            this.lesmatchs[n].color = "colorPD"
                        } else if (this.lesmatchs[n].poule=="PE") {
                            this.lesmatchs[n].color = "colorPE"
                        } else {
                            this.lesmatchs[n].color = "colorPF"
                        }
                    }
                  }
                }).catch(error => {
