              ...
              <v-row>
                  <v-col>
                        <base-material-card color="colorPC" class="px-0"  >
                            <template v-slot:heading>
                                <div class="display-2 font-weight-light">{{ categorie_id }} - PouleC - Matchs</div>
                            </template>
                            <v-card-text class="px-0" >
                    ...
                    <v-col>
                        <base-material-card color="colorPC" class="px-0"  >
                            <template v-slot:heading>
                                <div class="display-2 font-weight-light">{{ categorie_id }} - PouleC - Classement</div>
                            </template>
                            <v-card-text class="px-0" >
        ...
        loadDataOds() {
            ...
            axios
                ...
                .then(response => {
                  ...
                  this.lesmatchsC = response.data.lesmatchs.filter(function (entry){return entry.categorie_id===categorie_id;}).filter(function (entry){return entry.poule==="PC";})
                  ...
                  this.leclassementC = response.data.lesclassements.filter(function (entry){return entry.categorie_id===categorie_id && entry.poule==="PC" ;})[0].leclassement
