<template>
    ...
    <template v-slot:heading>
        <div class="display-2 font-weight-light">{{ categorie_id }} - Barrage / Quarts de finale</div>
    </template>
...
<base-material-card color="colorF2" class="px-0">
<template v-slot:heading>
    <div class="display-2 font-weight-light">{{ categorie_id }} - Demi finales / finale</div>
</template>
<v-card-text class="px-0" >
